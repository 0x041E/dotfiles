...
" " ---------------------------------------------------------------------
" "
" " 1. Download the luna distribution (as a zip archive, available on the
" github page)
...
" " ---------------------------------------------------------------------
" "
" " After either manual or pathogen installation, put the following two lines
" in your
" " .vimrc:
" "
" " syntax enable
...
"     " Language Specifics: {{{
"     " ---------------------------------------------------------------------
"     " These are language specifics. These are set explicitly to override the
"     group
"     " highlighting provided by vim (Simply to make the language that you're
"     working
